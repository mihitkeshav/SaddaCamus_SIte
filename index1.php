            ...
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline" method="POST" action="restaurants1.php">
			    ...
			    <select class="form-control form-control-lg">
                                ...
                                <option value="1">IIT(ISM) Dhanbad</option>
                                <option value="2">RNT Medical College</option>
                            </select>
                            <button onclick="location.href='restaurants.html'" type="submit" class="btn theme-btn btn-lg">Get Food</button>
                        </form>
                    </div>
                    <div class="steps">
