        ...
        <section class="hero bg-image" data-image-src="http://placehold.it/1670x680">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Food</h1>
                    <h5 class="font-white space-xs">Find restaurant, order food, and get it delivered to your hostel</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <select class="form-control form-control-lg" id="location">
                                // <option selected class=" disabled">--Select Location--</option>
			    ...
			    <select class="form-control form-control-lg" id="college">
                                <option selected class=" disabled">--Select College--</option>
                               
                            </select>
                            <button onclick="location.href='restaurants.html'" type="button" class="btn theme-btn btn-lg">Get Food</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Get it Delive</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got you covered with menus from all your favorite restaurants online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>Get reviews on dishes from other foodies based on taste and quality</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your food delivered! And enjoy your meal! Pay online or on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="images/applicationNew.png" alt="Right Image" class="img-fluid"> </figure>
                            </div>
                            <div class="col-xs-12 col-sm-7 left-text">
                                ...
                                <div class="social-btns">
                                    ...
                                    <a href="https://play.google.com/store/apps/details?id=com.saddacampus.app" class="app-btn android-button clearfix">
...
RAJASTHAN, 313001, INDIA</p>
                            ...
                            <div class="row">
                              <a href="about.html"><small class="col-xs-4"  style="text-align: right; font-size:.7em">About Us </small></a>
                              <a href="tnc.html"><small class="col-xs-4"  style="text-align: center; font-size:.7em">Terms and Conditions </small></a>
                              <a href="privacy_policy.html"><small class="col-xs-4"  style="text-align: left; font-size:.7em">Privacy Policy</small></a>
                            </div>
                            <div class="row">
                              <a href="refund_policy.html"><small class="col-xs-6" style="text-align: right;padding-right:10px; font-size:.7em">Refunds Policy </small></a>
                              <a href="pricing_policy.html"><small class="col-xs-6"  style="text-align: left;padding-left:10px; font-size:.7em">Pricing Policy</small></a>
                          </div>
                        </div>
                    </div>
                    <!-- bottom footer ends -->
    ...
    <script type="text/javascript">
         ...
         $("#location").change(function () {
            ...
            if (str == "") {
                ...
                xmlhttp.open("GET","getCollege.php?q="+str,true);
                xmlhttp.send();
            }
        });
    </script>
